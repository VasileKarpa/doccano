...
from .views.project import CloneProject, ProjectDetail, ProjectList, PerspectiveListCreateView, PerspectiveDetailView, ProjectAnnotationsView
...
urlpatterns = [
    ...
    path(route="projects/<int:project_id>/discrepancies/auto", view=ProjectAnnotationsView.as_view(), name="project_annotations"),
]
