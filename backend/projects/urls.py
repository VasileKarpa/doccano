...
from .views.project import CloneProject, ProjectDetail, ProjectList, PerspectiveListCreateView, PerspectiveDetailView, AnnotatorPerspectiveListCreateView, AnnotatorPerspectiveDetailView
...
urlpatterns = [
    ...
    path(route="projects/<int:project_id>/perspective/<int:perspective_id>/annotators/",view=AnnotatorPerspectiveListCreateView.as_view(),name="annotator_perspective_list_create"),
    path(route="projects/<int:project_id>/perspective/<int:perspective_id>/annotators/<int:id>/",view=AnnotatorPerspectiveDetailView.as_view(),name="annotator_perspective_detail"),
